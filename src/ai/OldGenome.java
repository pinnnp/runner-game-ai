...
public class OldGenome implements Comparable<Object>{
	...
	public OldGenome(ArrayList<Integer> indexOfGenes, ArrayList<Double> oldGenome) { //Two parameters must have the same length
		for (int i = 0; i < 4; i++) {
